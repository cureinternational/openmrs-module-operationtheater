...
public class SurgicalAppointment extends BaseOpenmrsData {
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof SurgicalAppointment))
			return false;
		if (!super.equals(o))
			return false;
		...
		if (getPatient() != null ? !getPatient().equals(that.getPatient()) : that.getPatient() != null)
			return false;
		if (getActualStartDatetime() != null ? !getActualStartDatetime().equals(that.getActualStartDatetime())
		        : that.getActualStartDatetime() != null)
			return false;
		if (getActualEndDatetime() != null ? !getActualEndDatetime().equals(that.getActualEndDatetime())
		        : that.getActualEndDatetime() != null)
			return false;
